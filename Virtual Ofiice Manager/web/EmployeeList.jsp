<%-- 
    ...
    Created on : 26 Aug, 2024, 4:27:06 PM
    Author     : ayush
--%>
    ...
    <center>
        ...
        <table width="1200" cellpadding="10" cellspacing="0" border="1" bgcolor="lightblue">
            <tr style="background-color: dodgerblue; color: white"><th>Emp. Code</th><th>Emp. Name</th><th>Date of Birth</th>
                ...
                <th>E mail Address</th><th>Id Name</th><th>Id Number</th><th>Account Status</th><th>Action</th>
            </tr>
            <%
                DBCon db=new DBCon();
                    ...
                    if(rs.next())
                    {
                     ...
                     if(st==1)
                     {
                        out.println("<td style='color:green;'>Active</td><td><a href=BlockUnblock?email="+email+"&status=1><input type=button style='color:white;background-color:red;width:120px;height:30px;' value='Block Account'></a></td>"); 
                         ...
                         out.println("<td style='color:red;'>Block</td><td><a href=BlockUnblock?email="+email+"&status=0><input typr=button style='color:White;background-color:green;width:120px;height:30px;' value='UnBlock Account'></a></td>");
                     }
                    }
                }
                %>
